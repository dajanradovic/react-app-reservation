...
class ReservationTable extends React.Component {
    ...
    deleteReservation = (id)=>{
      axios.delete('https://laravel-react-api.xyz/api/reservations/'+id+'?token=' +this.props.token)
        .then(response => {
    ...
    deleteAllReservations = () =>{
      ...
      axios.post('https://laravel-react-api.xyz/api/reservations/deleteAll?token=' +this.props.token)
      .then(response => {
